      ...
      <Card className="max-w-3xl w-full px-6 py-8 flex gap-4.5">
              ...
              >
                <SelectTrigger
                  className={cn(
                    ...
                    errors.experienceLevel && "border-red-500 border-2",
                  )}
                >
            ...
            render={({ field }) => (
              ...
              >
                <SelectTrigger
                  className={cn(
                    "rounded-xl w-full py-3 px-4 text-base !h-12",
                    errors.contractType && "border-red-500 border-2",
                  )}
                >
          ...
          <Controller
            ...
            render={({ field }) => (
              <Editor
                ...
                className={cn(
                  "rounded-xl py-3 px-4 text-base h-12",
                  errors.jobDescription && "border-red-500 border-2",
                )}
                init={{
                  height: 400,
                  menubar: false,
          ...
          <Controller
            ...
            render={({ field }) => (
              <Editor
                ...
                className={cn(
                  "rounded-xl py-3 px-4 text-base h-12",
                  errors.qualifications && "border-red-500 border-2",
                )}
                init={{
                  height: 400,
                  menubar: false,
            ...
            <Controller
              ...
              render={({ field }) => (
                <Input
                  ...
                  className={cn(
                    "rounded-xl py-3 px-4 text-base h-12",
                    errors.salaryMin && "border-red-500 border-2",
                  )}
                  type="number"
                  min="0"
            ...
            <Controller
              ...
              render={({ field }) => (
                <Input
                  ...
                  className={cn(
                    "rounded-xl py-3 px-4 text-base h-12",
                    errors.salaryMax && "border-red-500 border-2",
                  )}
                  type="number"
                  min="0"
        ...
        <div className="flex flex-col gap-2">
                  ...
                  <PopoverTrigger asChild>
                    <Button
                      ...
                      className={cn(
                        ...
                        errors.jobPostDates?.start && "border-red-500 border-2",
                      )}
                    >
                  ...
                  <PopoverContent className="p-0" align="start">
                    <Calendar
                      ...
                      onSelect={(newDate) => {
                        ...
                        setValue("jobPostDates.start", newDate, {
                          shouldValidate: true,
                        });
                      }}
                      disabled={(start_date) =>
                  ...
                  <PopoverTrigger asChild>
                    <Button
                      ...
                      className={cn(
                        ...
                        errors.jobPostDates?.end && "border-red-500 border-2",
                      )}
                    >
                      <CalendarIcon className="mr-2 h-4 w-4" />
                      {end_date ? (
                  ...
                  <PopoverContent className="p-0" align="start">
                    <Calendar
                      ...
                      onSelect={(newDate) => {
                        setEndDate(newDate);
                        field.onChange(newDate);
                        setValue("jobPostDates.end", newDate, {
                          shouldValidate: true,
                        });
                      }}
                      disabled={(date) =>
          ...
          <div>
            ...
            {(errors.jobPostDates?.start || errors.jobPostDates?.end) && <br />}
